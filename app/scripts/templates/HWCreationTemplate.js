...
homeworkBuddy.templates.HWCreationTemplate = '<h2>Make Some Homework</h2>\
<input type = "text" class = "chewy" id = "assignmentName" placeholder = "Your awesome assignment name goes here"/><br>\
